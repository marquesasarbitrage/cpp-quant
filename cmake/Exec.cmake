...
#add_executable(quant-test3 ${CMAKE_CURRENT_SOURCE_DIR}/tests/test3.cpp)
#target_link_libraries(quant-test3 PUBLIC cpp-quant)

# Nelson-Siegel focus tests
add_executable(quant-test4 ${CMAKE_CURRENT_SOURCE_DIR}/tests/test4.cpp)
